...
「あきこ」は、**筑波大学の学生向け**の履修サポートWebツールです。\
このツールは、みなさんが毎年直面する**履修計画の面倒くささ**を解決するために開発されました。\
履修要覧やTwinsを使って手作業で管理する今までのやり方とは違い、\
「あきこ」なら **単位の計算**・**授業探し**・**Twinsへの登録** があっという間におわります。

<img width="1200" height="628" alt="demo" src="https://github.com/user-attachments/assets/be6c928e-36fa-48e4-ac5b-5a0406a0adb2" />
...
質問や提案がある場合は、以下のフォームからお問い合わせください。

**「あきこ」のフィードバックフォームはこちら**: \
https://docs.google.com/forms/d/e/1FAIpQLSfUbueFsF6fbyJxCohNTqh5S8bYdxNgqx_HQ76RCR5TJQkpyQ/viewform
