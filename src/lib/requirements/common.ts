...
export function isJapanExpertJapanese(id: string): boolean {
  return (
    ...
    id === "3910522" || // 日本語作文IIB
    id === "3910622" || // 日本語演習IIB
    id === "3920112" || // 2023年度: Japan-Expert日本語 中上級話す
    id === "3920122" || // 2023年度: Japan-Expert日本語 上級話す
    id === "3920132" || // 2024, 2025年度: JE日本語 中上級話す
    id === "3920212" || // 2023年度: Japan-Expert日本語 中上級聞く
    id === "3920222" || // 2023年度: Japan-Expert日本語 上級聞く
    id === "3920232" || // 2024, 2025年度: JE日本語 中上級聞く
    id === "3920322" || // 2023年度: Japan-Expert日本語 上級読む
    id === "3920312" || // 2023年度: Japan-Expert日本語 中上級読む
    id === "3920332" || // 2024, 2025年度: JE日本語 中上級読む
    id === "3920412" || // 2023年度: Japan-Expert日本語 中上級書く
    id === "3920422" || // 2023年度: Japan-Expert日本語 上級書く
    id === "3920432" || // 2024, 2025年度: JE日本語 中上級書く
    id === "3920512" || // 2023年度: Japan-Expert日本語 中上級文法
    id === "3920522" || // 2023年度: Japan-Expert日本語 上級文法
    id === "3920532" || // 2024, 2025年度: JE日本語 中上級文法
    id === "3920612" || // 2023年度: Japan-Expert日本語 中上級漢字
    id === "3920622" || // 2023年度: Japan-Expert日本語 上級漢字
    id === "3920632" || // 2024, 2025年度: JE日本語 中上級漢字
    id === "3920712" || // 2023年度: Japan-Expert日本語 中上級総合日本語
    id === "3920722" || // 2023年度: Japan-Expert日本語 上級総合日本語
    id === "3920732" || // 2024, 2025年度: JE日本語 中上級総合日本語
    id === "3920242" || // 2024, 2025年度: JE日本語 上級聞く
    id === "3920442" || // 2024, 2025年度: JE日本語 上級書く
    id === "3920542" || // 2024, 2025年度: JE日本語 上級文法
    id === "3920642" || // 2024, 2025年度: JE日本語 上級漢字
    id === "3920742" || // 2024, 2025年度: JE日本語 上級総合日本語
