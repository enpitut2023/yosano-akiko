...
function isD1(id: string, tableYear: number): boolean {
  return (
    ...
    id === "FCB1201" || //  力学1(応用理工学類・工学システム学類の学生 原則平成31年度以降入学者)
    id === "FCB1211" || //  力学1(物理学類、化学類、数学類、地球学類、生物学類 原則平成31年度以降入学者)
    id === "FCB1221" || //  力学1(医学類・医療科学学類の学生 原則平成31年度以降入学者)
    id === "FCB1231" || //  力学1(総合学域群の学生 原則平成31年度以降入学者)
    id === "FCB1241" || //  力学2(応用理工学類・工学システム学類の学生 原則平成31年度以降入学者)
    id === "FCB1251" || //  力学2(物理学類、化学類、数学類、地球学類、生物学類 原則平成31年度以降入学者)
    id === "FCB1261" || //  力学2(総合学域群の学生 原則平成31年度以降入学者)
    id === "FCB1271" || //  力学3(物理学類、化学類、数学類、地球学類、生物学類 原則平成31年度以降入学者) !!A!!
    id === "FCB1281" || //  力学3(総合学域群の学生 原則平成31年度以降入学者)
    id === "FCB1291" || //  力学3(応用理工学類・工学システム学類の学生 原則平成31年度以降入学者)
