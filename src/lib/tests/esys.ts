...
} from "$lib/requirements/esys-since-2023";
import { runTest } from "./util";

function test1(): void {
  runTest({
    csvPath: "grade-csvs/2023/esys-ies-1.csv",
    isNative: true,
    tableYear: 2023,
    major: "esys-ies",
    getCreditRequirements,
...
function test2(): void {
  runTest({
    csvPath: "grade-csvs/2023/esys-ies-2.csv",
    isNative: true,
    tableYear: 2023,
    major: "esys-ies",
    getCreditRequirements,
...
function test3(): void {
  runTest({
    csvPath: "grade-csvs/2023/esys-eme-1.csv",
    isNative: true,
    tableYear: 2023,
    major: "esys-eme",
    getCreditRequirements,
    ...
    want: {
      cells: {
        ...
        a2: { taken: 3 },
        a3: { mightTake: 6 },
        a4: { taken: 2, mightTake: 1 },
        b1: { taken: 24, mightTake: 1 },
        b2: { taken: 1, mightTake: 11 },
        c1: { taken: 1 },
        c2: { taken: 1 },
        c3: { taken: 1 },
        c4: { taken: 1 },
      ...
      compulsory: { taken: 53, mightTake: 7 },
      elective: { taken: 40, mightTake: 12 },
    },
  });
}
