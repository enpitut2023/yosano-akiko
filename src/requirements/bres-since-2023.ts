...
function isH1(id: string): boolean {
  return !/^(EC|EB|EE|EG|EZA|BB|FF|FH|[123469])/.test(id) ||
id === "9460001" || // 農業科教育法概論 西暦偶数年度開講
id === "9462001" || // 技術科教育法概論 西暦奇数年度開講
id === "9454121" || // 理科教育概論IIA !!B!! 注5の理科教育概論はこれか
id === "9454221" || // 理科教育概論IIB !!B!! 
id === "9200111" || // 現代教育と教育理念 !!A!! わからんから全部表示
id === "9200121" || // 現代教育と教育理念
id === "9200131" || // 現代教育と教育理念
id === "9200141" || // 現代教育と教育理念
id === "9200151" || // 現代教育と教育理念
id === "9200211" || // 教育史概論
id === "9200221" || // 教育史概論
id === "9200231" || // 教育史概論
id === "9200241" || // 教育史概論
...
function isH2As(id: string): boolean {
  return !/^(EC|EB|EE|EG[56]|EZA|BB|FF|FH|[123469])/.test(id) || 
  id === "9460001" || // 農業科教育法概論 西暦偶数年度開講
id === "9462001" || // 技術科教育法概論 西暦奇数年度開講
id === "9454121" || // 理科教育概論IIA !!B!! 注5の理科教育概論はこれか
id === "9454221" || // 理科教育概論IIB !!B!! 
...
export function getRemark(
  ...
  if(id === "h1" && specialty === "none" || id === "h2" && specialty === "as"){
    return `注5の条件はチェックされないため、あきこでは足りているのに実際は足りてないことがあるので注意してください。また、専門基礎科目として認定される科目も存在するので注意してください。`
  }
}
